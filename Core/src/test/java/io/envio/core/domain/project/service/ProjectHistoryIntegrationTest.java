...
class ProjectHistoryIntegrationTest {
	...
	void project_history_full_flow_test() {
		...
		// v1
		projectFacadeService.push(projectA.getId(), ProjectPushReqDto.builder()
			.githubUserId("user-1")
		...
		projectFacadeService.push(projectB.getId(), ProjectPushReqDto.builder()
			.githubUserId("user-3")
		...
		List<ProjectHistoryResDto> historyA = projectFacadeService.getProjectHistory(projectA.getId());
		...
		List<ProjectHistoryResDto> historyB = projectFacadeService.getProjectHistory(projectB.getId());
